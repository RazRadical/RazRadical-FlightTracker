...
public class FlightService {
    ...
    public Flight updateFlight(int flight_id, Flight flight){
        ...
        Flight modFlight = flightDAO.getFlightById(flight_id);
        return modFlight;
    }
    ...
    public List<Flight> getAllFlights() {
        List<Flight> flightList = new LinkedList<Flight>(flightDAO.getAllFlights());
        return flightList;
    }
    ...
    public List<Flight> getAllFlightsFromCityToCity(String departure_city, String arrival_city) {
        List<Flight> flightList = new LinkedList<Flight>(flightDAO.getAllFlightsFromCityToCity(departure_city, arrival_city));
